...
(
    ...
    `start_test_job_name`       VARCHAR(50) DEFAULT NULL COMMENT '执行测试job，不为空时表示已经创建job',
...
(
    ...
    `test_command`            VARCHAR(100)      NULL COMMENT '测试命令',
    ...
    `command_run_case_type`   TINYINT DEFAULT 1 NOT NULL COMMENT '命令运行的测试用例类型  1 文本 2 文件',
...
(
    ...
    `create_user_id`  INT               NOT NULL COMMENT '创建人id',
    `case_count`      INT               NULL COMMENT '用例数量',
    `remark`          VARCHAR(100)      NULL COMMENT '备注',
